...
<div class="panel panel-default">
    <div class="panel-body">
        <div class="user-index">
            ...
            <div class="btn-group">
                <button data-toggle="dropdown" class="btn btn-primary btn-lg" aria-expanded="true">
            ...
            GridView::widget([
                ...
                'tableOptions' => ['id' => 'dynamic-table', 'class' => 'table table-striped table-bordered table-hover'],
