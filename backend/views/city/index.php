...
$this->params['description'] = 'Here you can manage cities use thoughout the system';
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="city-index">
            ...
            <p>
                <?= Html::a(Yii::t('app', "<i class='fa fa-plus'></i> " . 'Create City'), ['create'], ['class' => 'btn btn-primary btn-lg']) ?>
            </p>
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => 'state_id',
                        'value' => 'state.name',
                        'filter' => \yii\helpers\ArrayHelper::map(\backend\models\State::find()->all(), 'id', 'name'),
                        'enableSorting' => true,
                    ],
                    'name',
                    [
