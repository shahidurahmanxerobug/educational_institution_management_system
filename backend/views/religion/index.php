...
$this->params['description'] = 'Here you can manage religions use thoughout the system';
$this->title = Yii::t('app', 'Religions Index');
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="religion-index">
            ...
            <p>
                <?= Html::a(Yii::t('app', "<i class='fa fa-plus'></i> " . 'Create Religion'), ['create'], ['class' => 'btn btn-primary btn-lg']) ?>
            </p>
