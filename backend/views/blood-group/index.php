...
$this->params['description'] = 'Here you can manage blood groups use thoughout the system';
$this->title = Yii::t('app', 'Blood Groups');
...
<div class="panel panel-default">
    <div class="panel-body">
            ...
            <p>
                <?= Html::a(Yii::t('app', "<i class='fa fa-plus'></i> " . 'Create Blood Group'), ['create'], ['class' => 'btn btn-primary btn-lg']) ?>
            </p>
