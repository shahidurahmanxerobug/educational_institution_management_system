...
$this->params['description'] = 'Here you can manage address types use thoughout the system';
$this->title = Yii::t('app', 'Address Types');
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="address-type-index">
            ...
            <p>
                <?= Html::a(Yii::t('app', "<i class='fa fa-plus'></i> " . 'Create Address Type'), ['create'], ['class' => 'btn btn-primary btn-lg']) ?>
            </p>
