...
$this->params['description'] = 'Here you can manage state use thoughout the system';
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="state-index">
            ...
            <p>
<?= Html::a(Yii::t('app', "<i class='fa fa-plus'></i> " . 'Create State'), ['create'], ['class' => 'btn btn-primary btn-lg']) ?>
            </p>
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => 'country.name',
                        'filter' => \yii\helpers\ArrayHelper::map(\backend\models\Country::find()->all(), 'id', 'name'),
                        'enableSorting' => true,
                    ],
                    'name',
                    [
