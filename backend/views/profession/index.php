...
$this->params['description'] = 'Here you can manage professions use thoughout the system';
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="profession-index">
            ...
            <p>
                <?= Html::a(Yii::t('app', "<i class='fa fa-plus'></i> " . 'Create Profession'), ['create'], ['class' => 'btn btn-primary btn-lg']) ?>
            </p>
