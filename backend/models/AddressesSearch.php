...
class AddressesSearch extends Addresses
{
    ...
    {
        return [
            [['id', 'user_id', 'address_type_id', 'city_id', 'state_id', 'country_id'], 'integer'],
            [['address_phone', 'house_no', 'street', 'detail'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'address_phone', $this->address_phone])
